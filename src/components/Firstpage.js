...
<header className="w3-display-container w3-content w3-wide " style={{maxWidth: "1600px", minWidth: "500px"}} id="home">
  <img className="w3-image" src="https://www.w3schools.com/w3images/hamburger.jpg" alt="Hamburger Catering" width="1300" height="400"/>
...
<div className="w3-content" style={{maxWidth: "1100px"}}>
  ...
  <div className="w3-row w3-padding-64" id="about">
    <div className="w3-col m6 w3-padding-large w3-hide-small">
     <img src="https://media.istockphoto.com/id/1269122740/photo/pizza-with-very-much-cheese-melting.jpg?s=612x612&w=0&k=20&c=61EQYbnkiUaH64gdiCtnExqIn4f84i6GhBJtQ9NGdPk="
      className="w3-round w3-image w3-opacity-min" alt="Table Setting" width="1300" height="400px"/>
    </div>
  ...
  <div className="row w3-padding-64" id="menu">
    <div className="col-6 w3-padding-large">
    ...
    <div className="col-6 w3-padding-large">
      <img src="https://www.w3schools.com/w3images/tablesetting.jpg" className="w3-round w3-image w3-opacity-min"
