...
import "./SideDishes.css"; // 👈 add this new CSS file for theme support
          ...
          {items.map(
            (d1, index) =>
              d1.type === "Side Dish" && (
                ...
                >
                  <div
                    className="text-center border rounded-4 p-3 shadow-sm h-100 d-flex flex-column justify-content-between side-card"
                    style={{
